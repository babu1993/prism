...
variable "allowed_ssh_cidr" {
  description = "CIDR allowed to SSH into the public instance"
  type        = string
  default     = "0.0.0.0/0"
}
...
output "public_instance_ip" {
  description = "Public IP of the bastion/public instance"
  value       = aws_instance.public_bastion.public_ip
}

output "private_instance_ips" {
  description = "Private IPs of the three private instances"
